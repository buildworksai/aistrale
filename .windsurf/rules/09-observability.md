...
# 📊 AISTRALE Observability Standards

**⚠️ CRITICAL**: Phase 2 observability is implemented. All services MUST follow these patterns for logging, metrics, and tracing.
...
```python
# ✅ REQUIRED: Structured logging setup (Phase 2 - Implemented)
...
### Tracing Usage
```python
# ✅ GOOD: Manual tracing for LLM calls
from opentelemetry import trace
...
### Sentry Integration
```python
# ✅ REQUIRED: Sentry error tracking (Phase 2 - Implemented)
# backend/main.py
import sentry_sdk
...
```python
# ✅ GOOD: Request/response logging middleware
import uuid
import time
import structlog
...
- ✅ Use metrics for business and technical metrics
- ✅ Trace all external calls (LLM APIs)
- ✅ Monitor error rates and latency

### Don'ts
- ❌ Don't log sensitive information (passwords, tokens)
- ❌ Don't log at ERROR level for expected errors
- ❌ Don't create too many metrics (keep it focused)
