...
# 🧪 AISTRALE Testing Standards

**⚠️ CRITICAL**: All code must be tested. Aim for >80% test coverage. Tests must pass before merging PRs.
...
```python
# ✅ GOOD: Integration test with test client
import pytest
...
### Mocking LLM APIs
```python
# ✅ GOOD: Mocking external LLM services
import pytest
