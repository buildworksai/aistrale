...
async def complete_request(
    request_id: int, service: QueueService = Depends(get_queue_service)
):
...
def get_circuit_status(
        provider: str,
        service: CircuitBreakerService = Depends(get_circuit_service)):
...
def get_benchmarks(
        provider: str,
        service: ReliabilityBenchmarkService = Depends(get_benchmark_service)):
