...
def test_rate_limiting(client: TestClient):
    ...
    # Let's try to hit a public endpoint if we limited one, but we limited authenticated ones.
    pass
...
def test_prompt_rendering_flow(client: TestClient, mock_session: Session):
    ...
    # So we should test the service directly or integration test with mocked external API
    pass
