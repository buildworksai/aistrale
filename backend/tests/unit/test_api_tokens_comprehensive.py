...
class TestTokensAPI:
    ...
    def test_create_token_set_default(self, client, mock_session):
        ...
        existing_token = Token(id=2, user_id=1, provider="openai", encrypted_token="enc", label="Old", is_default=True)
    ...
    def test_delete_token_wrong_user(self, client, mock_session):
        ...
        wrong_token = Token(id=1, user_id=2, provider="openai", encrypted_token="enc", label="Token")
    ...
    def test_update_token_set_default(self, client, mock_session, test_token):
        ...
        existing_default = Token(id=2, user_id=1, provider="openai", encrypted_token="enc", label="Old", is_default=True)
