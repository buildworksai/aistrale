...
class TestInferenceAPI:
    ...
    @pytest.mark.asyncio
    async def test_run_inference_endpoint(self, client, mock_session, test_token):
    ...
    @pytest.mark.asyncio
    async def test_run_inference_provider_mismatch(self, client, mock_session, test_token):
    ...
    def test_get_chat_history(self, client, mock_session):
        ...
        msg2 = ChatMessage(id=2, user_id=1, role="assistant", content="Hi there")
