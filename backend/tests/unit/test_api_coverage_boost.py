...
class TestPromptsCoverage:
    ...
    def test_create_prompt_name_exists(self, mock_user_id, client, mock_session):
        ...
        existing_prompt = Prompt(id=1, name="existing", template="Hello", user_id=1, version=1)
    ...
    @patch("api.prompts.get_current_user_id")
    def test_read_prompts_with_pagination(self, mock_user_id, client, mock_session):
...
class TestTelemetryCoverage:
    ...
    def test_get_cost_analytics_all_paths(self, mock_user_id, client, mock_session):
        ...
        telemetry2 = Telemetry(
            ...
            cost=0.002, created_at=datetime.utcnow() - timedelta(days=1)
        )
...
class TestTokensCoverage:
    ...
    def test_create_token_with_default(self, mock_user_id, client, mock_session):
    ...
    @patch("api.tokens.get_current_user_id")
    def test_set_default_token_unset_others(self, mock_user_id, client, mock_session):
...
class TestSecurityAuditCoverage:
    ...
    def test_list_audit_events_with_filters(self, mock_require_admin, client, mock_session):
...
class TestInferenceCoverage:
    ...
    async def test_run_inference_all_paths(self, mock_request, client, mock_session):
