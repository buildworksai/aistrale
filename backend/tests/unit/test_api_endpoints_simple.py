...
class TestSecurityAuditEndpoints:
    ...
    def test_list_audit_events_admin(self, admin_client, mock_session):
        ...
        events = [
            SecurityAudit(id=1, event_type="login_success", user_id=1, ip_address="127.0.0.1", details={}),
            SecurityAudit(id=2, event_type="login_failure", user_id=None, ip_address="127.0.0.1", details={})
        ]
        mock_result = MagicMock()
