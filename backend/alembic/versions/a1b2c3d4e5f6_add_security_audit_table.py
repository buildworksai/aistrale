...
down_revision: str | Sequence[str] | None = "de9c1517c9c5"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_securityaudit_event_type"),
        "securityaudit",
        ["event_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_securityaudit_user_id"),
        "securityaudit",
        ["user_id"],
        unique=False)
    op.create_index(
        op.f("ix_securityaudit_created_at"),
        "securityaudit",
        ["created_at"],
        unique=False,
    )
